...
public class TrackMiddleReef_Right extends Command {
  ...
  public TrackMiddleReef_Right(PhotonVisionSubsystem photonVisionSubsystem, SwerveSubsystem_Kraken swerveSubsystem) {
  ...
  public void execute() {
    if(m_PhotonVision.hasFrontLeftTarget()) {
      ...
      xMeasurement = xPidError >= 0.02 ? xMeasurement : PhotonConstants.xPidSetPoint_MiddleReef_FrontLeft;
    ...
    if(m_PhotonVision.isArrive_Reef("MiddleReef_FrontLeft")) {
