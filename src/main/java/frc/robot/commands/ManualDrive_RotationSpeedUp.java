...
public class ManualDrive_RotationSpeedUp extends Command {
  /** Creates a new ManualDrive_RotationSpeedUp. */
  ...
  public ManualDrive_RotationSpeedUp(SwerveSubsystem_Kraken swerveSubsystem, DoubleSupplier xSpeed, DoubleSupplier ySpeed, DoubleSupplier zSpeed, BooleanSupplier isSlow) {
  ...
  public void execute() {
    ...
    if((isSlow && ElevatorConstants.arriveLevel == 2) || ElevatorConstants.arriveLevel == 2) {
      ...
      zSpeed = zSpeed*Math.abs(zSpeed)*0.5;
    }
