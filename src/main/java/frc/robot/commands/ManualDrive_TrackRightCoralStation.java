...
public class ManualDrive_TrackRightCoralStation extends Command {
  ...
  public ManualDrive_TrackRightCoralStation(SwerveSubsystem_Kraken swerveSubsystem, PhotonVisionSubsystem photonVisionSubsystem, DoubleSupplier xSpeed, DoubleSupplier ySpeed, DoubleSupplier zSpeed, BooleanSupplier isSlow) {
